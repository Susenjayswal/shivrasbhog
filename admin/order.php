						...
						<div class="fxt-form">
							...
							<div class="form-group">
                                        <div class="fxt-transformY-50 fxt-transition-delay-1">
                                           <label>Invoice No.</label> <input type="text" id="invoiceno" name="invoiceno" value="<?php echo $invoiceno; ?>" readonly placeholder="Item" class="form-control lgx-input-form form-control"  required="required"/>
											
										</div>
                                    </div>		
							<div class="form-group">
                                        <div class="fxt-transformY-50 fxt-transition-delay-1">
                                            <input type="text" id="cname" name="cname" value="<?php echo $cname; ?>" readonly placeholder="Item" class="form-control lgx-input-form form-control"  required="required"/>
											<input type="hidden"  name="action1" value="cus_order">
										</div>
                                    </div>
                                    <div class="form-group">
                                        <div class="fxt-transformY-50 fxt-transition-delay-1">
                                            <input type="text" id="mobile" name="mobile" readonly value="<?php echo $mobile; ?>" placeholder="Item" class="form-control lgx-input-form form-control"  required="required"/>
                                        </div>
                                    </div>
