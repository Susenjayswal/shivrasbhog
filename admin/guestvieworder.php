      ...
      <table border="1" cellspacing="0" align="center" style="border-collapse:collapse; border-spacing:0px;">
        <tr>
          ...
          <td colspan="2" rowspan="2">
            <div align="center" style="font-style:oblique;"><strong>RASBHOG</strong></br>A unit of Shiv Rasbhog LLP
            </div>
          </td>
          <td colspan="2">
        ...
        <tr>
          ...
          <td align="center">
            <?php echo round(($totalprice * 2.5) / 100, 2); ?>
          </td>
        </tr>
        <tr>
        ...
        <tr>
          <td colspan="5" align="center" style="background-color:#FFFF99;">
            <h2><strong> &#128519; Thanks and Visit Again &#128519;</strong></h2>
          </td>
        </tr>
      </table>
  </div>
