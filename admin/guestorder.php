						...
						<div class="fxt-form">
							...
							<div class="form-group">
                                        <div class="fxt-transformY-50 fxt-transition-delay-1">
                                           <label>Invoice No.</label> <input type="text" id="invno" name="invno" value="<?php echo $invno; ?>" readonly placeholder="Item" class="form-control lgx-input-form form-control"  required="required"/>
