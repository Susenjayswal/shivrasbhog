			...
			<div class="row align-items-center justify-content-center">
				<div class="col-xl-6 col-lg-7 col-sm-12 col-12 fxt-bg-color">
					<div class="fxt-content">
						...
						<div class="fxt-form">
							<div class=order>
								<h2 align="center">Cancel Order Report </h2>
								<form class="fxt-form" method="post">
									<div class="form-group">
										<label> Enter Start Date</label>
										<input type="date" id="sdate2" name="sdate2" min="2023-06-01" placeholder="Enter Start Date"
											class="form-control">

									</div>
									<div class="form-group">
										<label> Enter End Date </label>
										<input type="date" id="edate2" name="edate2" min="2023-06-01" placeholder="Enter End Date"
											class="form-control">
									</div>
									<div class="form-group">
										<div class="fxt-transformY-50 fxt-transition-delay-4">
											<input type="button" name="btnsubmi" id="btnsubmi" value="Submit"
												class="fxt-btn-fill">
										</div>
									</div>
								</form>
...
<script>
	...
	today = yyyy + '-' + mm + '-' + dd;
	document.getElementById("edate2").setAttribute("max", today);
</script>
<script>
	var today = new Date();
	var dd = today.getDate();
	...
	today = yyyy + '-' + mm + '-' + dd;
	document.getElementById("sdate2").setAttribute("max", today);
</script>
	<script>
		$("#btnsubmi").on('click', function () {
			let sdate2 = $("#sdate2").val();
			let edate2 = $("#edate2").val();
			window.open('cancelreport.php?sdate2=' + sdate2 + '&edate2=' + edate2, '_parent');
		});
	</script>
</body>
