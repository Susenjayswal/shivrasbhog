...
<form class="fxt-form" method="post" action="../admin/actionemployee.php">
	...
	<input type="date" id="startdate" name="startdate" placeholder="Enter Start Date" class="form-control">
	</div>
	<div class="form-group">
	...
	<div class="form-group">
		<button type="button" name="btnsubmit5" id="btnsubmit5" class="fxt-btn-fill">Submit</button>
		</div>	
