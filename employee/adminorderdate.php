							...
							<div class=order>
								...
								<form class="fxt-form" method="post">
									<div class="form-group">
										...
										<input type="date" id="sdate" min="2023-06-15"name="sdate" placeholder="Enter Start Date"
											class="form-control">

									</div>
									<div class="form-group">
										<label> Enter End Date </label>
										<input type="date" id="edate" min="2023-06-15"name="edate" placeholder="Enter End Date"
											class="form-control">
									</div>
									<div class="form-group">
