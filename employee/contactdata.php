                            ...
                            <div class=payment>
                                ...
                                <form class="fxt-form" method="post" action="../admin/actionorder.php">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="date" id="enddate1" name="enddate1"  placeholder="Enter End Date"
                                            class="form-control">
                                    </div>
                                    <div class="form-group">
                                        <input type="button" name="btnsubmit6" id="btnsubmit6" value="Submit"
                                            class="fxt-btn-fill">
                                    </div>
                                    <div>
...
<script>
	...
	today = yyyy + '-' + mm + '-' + dd;
	document.getElementById("stadate").setAttribute("min", today);
</script>
    <script>
