							...
							<div class=stock>
								...
								<form class="fxt-form" method="post">
									<div class="form-group">
										...
										<input type="date" id="stadate" min="2023-06-15" name="stadate" placeholder="Enter Start Date"
											class="form-control">
									</div>
									<div class="form-group">
										<label> Enter End Date </label>
										<input type="date" id="enddate" min="2023-06-15" name="enddate" placeholder="Enter End Date"
											class="form-control">
									</div>
									<div class="form-group">
...
<script>
	...
	today = yyyy + '-' + mm + '-' + dd;
	document.getElementById("stadate").setAttribute("max", today);
</script>
	<script>
