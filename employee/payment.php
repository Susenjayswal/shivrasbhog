							...
							<div class=payment>
								...
								<form class="fxt-form" method="post" action="../admin/actionorder.php">
									<div class="form-group">
										...
										<input type="date" id="stdate" min="2023-06-15" name="stdate" placeholder="Enter Start Date"
											class="form-control">
									</div>
									<div class="form-group">
									...
									<div class="form-group">
										<input type="button" name="btnsubmit" id="btnsubmit" min="2023-06-15" value="Submit"
											class="fxt-btn-fill">
									</div>
									<div>
