            ...
            <div class="container">
                <div class="lgx-footer-area">
                    <div class="lgx-footer-single">
                        ...
                        <address>
                            ...
                            C/o Ishwar Chandra Jaiswal,Chowk Sikarpur, Patna City, Patna 800008 <br>
                            BIHAR,INDIA
                        </address>
                        <ul class="list-unstyled lgx-address-info">
                            <li><i class="fa fa-phone"></i>+91 9128798404</li>
                            <li><i class="fa fa-envelope"></i><a href="Cabasantjaiswal@gmail.com" class="__cf_email__" data-cfemail="48272e2e212b2d082d2c3d2b293c21272638243d3b662b2725">Cabasantjaiswal@gmail.com&#160;</a></li>
                        </ul>
                    </div> <!--//footer-area-->
                    <div class="lgx-footer-single">
                        ...
                        <div class="opening-time-single">
                            ...
                            <span><i>10:00</i> Am - <i>10:00</i> PM</span>
                        </div>
                        <div class="opening-time-single">
                            Saturday- Sunday
                        ...
                        <div class="opening-time-single">
                            On Festivals or any occasion
                            <span><i>09:00</i> Am - <i>11:00</i> PM</span>
                        </div>
                    </div> <!--//footer-area-->
                    <div class="lgx-footer-single">
                        ...
                        <div class="lgx-subscriber-area">
                            <div class="lgx-subscriber">
                                <form  name="frm"  method="POST" action="../admin/action.php" >
                                    ...
                                    <div class="form-group">
                                        <input type="feedback" id="feedback" name="feedback" placeholder="Your Feedback" class="form-control lgx-input-form form-control"  required="required"/>
                                    </div>
                                    <div class="form-group">
                ...
                <div class="lgx-footer-bottom">
                    <div class="lgx-copyright">
                        <p>© 2022 Rasbhog is powered by <a href=Cabasantjaiswal@gmail.com">Shiv Rasbhog.</a> The property of their owners.</p>
                    </div>
